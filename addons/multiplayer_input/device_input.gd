...
## Then you can call any of the methods listed here like this for example:
## [code]input.is_action_just_pressed("jump")[/code]
##
...
func get_vector(
	...
	return MultiplayerInput.get_vector(
		device, negative_x, positive_x, negative_y, positive_y, deadzone
	)
